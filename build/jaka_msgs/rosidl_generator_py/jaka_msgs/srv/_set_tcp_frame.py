...
class Metaclass_SetTcpFrame(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from jaka_msgs.srv import _set_tcp_frame
...
class SetTcpFrame(metaclass=Metaclass_SetTcpFrame):
    from jaka_msgs.srv._set_tcp_frame import SetTcpFrame_Request as Request
    from jaka_msgs.srv._set_tcp_frame import SetTcpFrame_Response as Response
