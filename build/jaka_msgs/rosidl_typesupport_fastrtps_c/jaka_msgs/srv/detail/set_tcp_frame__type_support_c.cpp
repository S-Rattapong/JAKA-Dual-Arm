...
#include "jaka_msgs/srv/detail/set_tcp_frame__rosidl_typesupport_fastrtps_c.h"
...
using _SetTcpFrame_Request__ros_msg_type = jaka_msgs__srv__SetTcpFrame_Request;
...
size_t get_serialized_size_jaka_msgs__srv__SetTcpFrame_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetTcpFrame_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_jaka_msgs__srv__SetTcpFrame_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_jaka_msgs
size_t max_serialized_size_jaka_msgs__srv__SetTcpFrame_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = jaka_msgs__srv__SetTcpFrame_Request;
    is_plain =
      (
...
static size_t _SetTcpFrame_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_jaka_msgs__srv__SetTcpFrame_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jaka_msgs, srv, SetTcpFrame_Request)() {
...
using _SetTcpFrame_Response__ros_msg_type = jaka_msgs__srv__SetTcpFrame_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_jaka_msgs
size_t get_serialized_size_jaka_msgs__srv__SetTcpFrame_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetTcpFrame_Response__ros_msg_type * ros_message = static_cast<const _SetTcpFrame_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_jaka_msgs__srv__SetTcpFrame_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_jaka_msgs
size_t max_serialized_size_jaka_msgs__srv__SetTcpFrame_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = jaka_msgs__srv__SetTcpFrame_Response;
    is_plain =
      (
...
static size_t _SetTcpFrame_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_jaka_msgs__srv__SetTcpFrame_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jaka_msgs, srv, SetTcpFrame_Response)() {
...
// already included above
// #include "jaka_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "jaka_msgs/srv/set_tcp_frame.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jaka_msgs, srv, SetTcpFrame)() {
