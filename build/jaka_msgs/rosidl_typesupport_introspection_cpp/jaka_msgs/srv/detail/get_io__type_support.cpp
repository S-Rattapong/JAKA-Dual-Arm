...
{
  new (message_memory) jaka_msgs::srv::GetIO_Request(_init);
}

void GetIO_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<jaka_msgs::srv::GetIO_Request *>(message_memory);
  typed_message->~GetIO_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember GetIO_Request_message_member_array[4] = {
  {
    "signal",  // name
    ...
    offsetof(jaka_msgs::srv::GetIO_Request, signal),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(jaka_msgs::srv::GetIO_Request, path),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(jaka_msgs::srv::GetIO_Request, type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(jaka_msgs::srv::GetIO_Request, index),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetIO_Request_message_members = {
  ...
  4,  // number of fields
  sizeof(jaka_msgs::srv::GetIO_Request),
...
{
  return &::jaka_msgs::srv::rosidl_typesupport_introspection_cpp::GetIO_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, jaka_msgs, srv, GetIO_Request)() {
  return &::jaka_msgs::srv::rosidl_typesupport_introspection_cpp::GetIO_Request_message_type_support_handle;
}
...
void GetIO_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) jaka_msgs::srv::GetIO_Response(_init);
}

void GetIO_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<jaka_msgs::srv::GetIO_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetIO_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(jaka_msgs::srv::GetIO_Response, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(jaka_msgs::srv::GetIO_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetIO_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(jaka_msgs::srv::GetIO_Response),
...
{
  return &::jaka_msgs::srv::rosidl_typesupport_introspection_cpp::GetIO_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, jaka_msgs, srv, GetIO_Response)() {
  return &::jaka_msgs::srv::rosidl_typesupport_introspection_cpp::GetIO_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GetIO_service_members = {
  ...
  // see get_service_type_support_handle<jaka_msgs::srv::GetIO>()
...
get_service_type_support_handle<jaka_msgs::srv::GetIO>()
{
  ...
  auto service_type_support =
    &::jaka_msgs::srv::rosidl_typesupport_introspection_cpp::GetIO_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, jaka_msgs, srv, GetIO)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<jaka_msgs::srv::GetIO>();
}
