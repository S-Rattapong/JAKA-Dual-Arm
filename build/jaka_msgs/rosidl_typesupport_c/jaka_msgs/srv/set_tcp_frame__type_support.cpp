...
static const _SetTcpFrame_Request_type_support_symbol_names_t _SetTcpFrame_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jaka_msgs, srv, SetTcpFrame_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, jaka_msgs, srv, SetTcpFrame_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, jaka_msgs, srv, SetTcpFrame_Request)() {
  return &::jaka_msgs::srv::rosidl_typesupport_c::SetTcpFrame_Request_message_type_support_handle;
}
...
static const _SetTcpFrame_Response_type_support_symbol_names_t _SetTcpFrame_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jaka_msgs, srv, SetTcpFrame_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, jaka_msgs, srv, SetTcpFrame_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, jaka_msgs, srv, SetTcpFrame_Response)() {
  return &::jaka_msgs::srv::rosidl_typesupport_c::SetTcpFrame_Response_message_type_support_handle;
}
...
static const _SetTcpFrame_type_support_symbol_names_t _SetTcpFrame_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jaka_msgs, srv, SetTcpFrame)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, jaka_msgs, srv, SetTcpFrame)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, jaka_msgs, srv, SetTcpFrame)() {
  return &::jaka_msgs::srv::rosidl_typesupport_c::SetTcpFrame_service_type_support_handle;
}
