...
#ifndef JAKA_MSGS__SRV__DETAIL__MOVE__FUNCTIONS_H_
#define JAKA_MSGS__SRV__DETAIL__MOVE__FUNCTIONS_H_
 ...
 * calls
 * jaka_msgs__srv__Move_Request__init().
...
/**
 * It calls
 * jaka_msgs__srv__Move_Request__fini()
 ...
 * jaka_msgs__srv__Move_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * jaka_msgs__srv__Move_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jaka_msgs__srv__Move_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jaka_msgs
...
/**
 * It calls
 * jaka_msgs__srv__Move_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_jaka_msgs
...
/**
 * It allocates the memory for the array and calls
 * jaka_msgs__srv__Move_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jaka_msgs
...
/**
 * It calls
 * jaka_msgs__srv__Move_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // JAKA_MSGS__SRV__DETAIL__MOVE__FUNCTIONS_H_
