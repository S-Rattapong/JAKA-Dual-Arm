...
static const _SetIO_Request_type_support_symbol_names_t _SetIO_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, jaka_msgs, srv, SetIO_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, jaka_msgs, srv, SetIO_Request)),
  }
};
...
{
  return &::jaka_msgs::srv::rosidl_typesupport_cpp::SetIO_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, jaka_msgs, srv, SetIO_Request)() {
  return get_message_type_support_handle<jaka_msgs::srv::SetIO_Request>();
}
...
static const _SetIO_Response_type_support_symbol_names_t _SetIO_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, jaka_msgs, srv, SetIO_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, jaka_msgs, srv, SetIO_Response)),
  }
};
...
{
  return &::jaka_msgs::srv::rosidl_typesupport_cpp::SetIO_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, jaka_msgs, srv, SetIO_Response)() {
  return get_message_type_support_handle<jaka_msgs::srv::SetIO_Response>();
}
...
static const _SetIO_type_support_symbol_names_t _SetIO_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, jaka_msgs, srv, SetIO)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, jaka_msgs, srv, SetIO)),
  }
};
...
{
  return &::jaka_msgs::srv::rosidl_typesupport_cpp::SetIO_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, jaka_msgs, srv, SetIO)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<jaka_msgs::srv::SetIO>();
}
