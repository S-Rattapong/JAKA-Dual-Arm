...
static const _GetFK_Request_type_support_symbol_names_t _GetFK_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, jaka_msgs, srv, GetFK_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, jaka_msgs, srv, GetFK_Request)),
  }
};
...
{
  return &::jaka_msgs::srv::rosidl_typesupport_cpp::GetFK_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, jaka_msgs, srv, GetFK_Request)() {
  return get_message_type_support_handle<jaka_msgs::srv::GetFK_Request>();
}
...
static const _GetFK_Response_type_support_symbol_names_t _GetFK_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, jaka_msgs, srv, GetFK_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, jaka_msgs, srv, GetFK_Response)),
  }
};
...
{
  return &::jaka_msgs::srv::rosidl_typesupport_cpp::GetFK_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, jaka_msgs, srv, GetFK_Response)() {
  return get_message_type_support_handle<jaka_msgs::srv::GetFK_Response>();
}
...
static const _GetFK_type_support_symbol_names_t _GetFK_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, jaka_msgs, srv, GetFK)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, jaka_msgs, srv, GetFK)),
  }
};
...
{
  return &::jaka_msgs::srv::rosidl_typesupport_cpp::GetFK_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, jaka_msgs, srv, GetFK)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<jaka_msgs::srv::GetFK>();
}
