...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("target_yaw", default_value="0.10"),
            DeclareLaunchArgument("num_waypoints", default_value="10"),
            DeclareLaunchArgument("object_length", default_value="0.70"),
            DeclareLaunchArgument("object_width", default_value="0.12"),
            DeclareLaunchArgument("object_height", default_value="0.04"),
            ...
            Node(
                ...
                executable="dual_object_final_demo",
                name="dual_object_final_demo_node",
                output="screen",
                parameters=[
                    {
                        ...
                        "object_length": ParameterValue(object_length, value_type=float),
                        "object_width": ParameterValue(object_width, value_type=float),
                        "object_height": ParameterValue(object_height, value_type=float),
