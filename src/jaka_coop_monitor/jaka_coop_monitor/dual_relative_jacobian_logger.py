...
class DualRelativeJacobianLogger(Node):
    def __init__(self):
        super().__init__('dual_relative_jacobian_logger')
        ...
        self.csv_path = self.log_dir / f'dual_relative_jacobian_{timestamp}.csv'
        ...
        self.writer.writerow([
            ...
            'relative_jacobian_rank',
            'relative_jacobian_condition_number',
            'x_dot_rel_norm',
            'scale',
    ...
    def write_csv(
        ...
        left_qdot = list(left_qdot)
        right_qdot = list(right_qdot)
        ...
        row = [
            ...
            math.degrees(orientation_error_angle),
            rank,
            condition_number,
            float(np.linalg.norm(x_dot_rel)),
            scale,
...
def main(args=None):
    ...
    node = DualRelativeJacobianLogger()
